...
CREATE TABLE `category` (
  ...
  `status` int NOT NULL DEFAULT '0' COMMENT '分类状态 0:禁用，1:启用',
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='员工信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `setmeal_dish` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin COMMENT='套餐菜品关系';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `setmeal_dish` VALUES (47,32,81,'1234',1.00,1),(48,32,82,'亲戚',100.00,1);
...
INSERT INTO `user` VALUES (4,'oUHkj4xz4Lk8hYhWNLVW6h8zVfIw',NULL,NULL,NULL,NULL,NULL,'2025-03-24 21:47:06');
...
-- Dump completed on 2025-03-25 19:43:54
